...
export class BlogRouter implements IRouterModel {
  ...
  //   this.insertFields = ['title', 'description', 'sides', 'content']
  //   this.updateFields = ['title', 'description', 'sides', 'content', 'visible', 'good_count', 'view_count', 'modify_time']
  // }

  // public checkLegitimate ({ query, body, params, headers, method }: Request) : boolean {
  //   const { limit, offset, visible } = query as any
  //   const {
  //     id, good_count, view_count, modify_time, sides
  //   } = body
  //   const {} = params
  //   const {} = headers
